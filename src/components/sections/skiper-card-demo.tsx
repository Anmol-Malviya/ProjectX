...
// Image paths - now using public directory paths
const shiftCard = "/images/features/feature-1.png";
const family = "/images/features/feature-2.png";
const carousel = "/images/features/feature-3.png";
const textureFull = "/images/features/feature-4.png";
const skiper = "/images/skiper.png";
const textureCard = "/images/texture-card.png";

import { SparklesIcon } from "lucide-react";
import { cn } from "@/src/lib/utils";
import { Badge } from "@/src/components/ui/badge";
import { SkiperCard } from "@/src/components/ui/skiper-card";
              ...
              <div className="relative z-10 grid w-full gap-8 rounded-[28px] bg-neutral-950 p-2">
                <SkiperCard
                  ...
                  image={{
                    ...
                    step4light: skiper,
                    alt: "Video Production Components",
                  }}
